...
@Component({
  selector: 'badgeflowview-item-req',
  templateUrl: './badgeflowview-item-req.component.html',
  styleUrls: ['./badgeflowview-item-req.component.scss']
})
export class BadgeFlowViewItemRequest extends BadgeItemComponent {
